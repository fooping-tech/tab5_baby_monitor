...
// The inference and preview workers stay unpinned so the scheduler can keep
// them off whichever core is busy; core 1 already carries three camera tasks
// at higher priority than either worker.
